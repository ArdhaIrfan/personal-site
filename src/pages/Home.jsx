    ...
    <>
      ...
      <div className={styles.hero}>
        <div className={`${styles.wrapper} ${styles.flexColumn}`}>
          <div>
            <h1>Ardha Irfan</h1>
            <p>Product Management Enthusiast</p>
          </div>
      ...
      <section id="profile" className={styles.profile}>
        ...
        <div className={styles.content}>
          <div className={`${styles.summary} ${styles.flexRow}`}>
            ...
            <div>
              <h2>Ardha Irfan</h2>
              <p className={styles.role}>Product Management Enthusiast</p>
            ...
            <div className={`${styles.catDetail} ${styles.flexRow}`}>
              ...
              <div className={styles.catList}>
                ...
                <div>
                  ...
                  <ul className={styles.detailedRole}>
                    <li>Formulated badminton training programs for over 200 members.</li>
                    <li>Coached the members based on the badminton training programs.</li>
          ...
          <div className={styles.right}>
            <div className={styles.group}>
              ...
              <div className={styles.porto}>
                <Link to='https://drive.google.com/drive/folders/1hnrnPa_AnsFa5TLM1vdY4jcMHVjjve9N?usp=drive_link'>PM Portfolio</Link>
